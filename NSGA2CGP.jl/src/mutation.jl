...
function uniform_mutate(cfg::NamedTuple, ind::NSGA2CGPInd)::NSGA2CGPInd
...
function goldman_mutate(cfg::NamedTuple, ind::NSGA2CGPInd)::NSGA2CGPInd
...
function profiling_mutate(cfg::NamedTuple, ind::NSGA2CGPInd, inputs::Array{Float64})::NSGA2CGPInd
    child = uniform_mutate(cfg, ind)
    while true
